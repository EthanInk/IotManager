...
public class AttributeService {
    ...
    public Attribute getAttributeWithToken(String token) {
        Optional<PublicAccessToken> publicAccessToken = publicAccessTokenRepository.findById(token);
        return publicAccessToken.map(PublicAccessToken::getAttribute).orElse(null);
    }
}
